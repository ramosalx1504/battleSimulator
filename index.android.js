...
AppRegistry.registerComponent('simulador', () => RootComponent);
...
//   render() {
//     let dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('./assets/icon.png') : require('./assets/icon.png');
//     return (
...
// AppRegistry.registerComponent('simulador', () => Demo);